execute if entity @s[tag=h3_nozzlenose] run summon armor_stand ^ ^ ^1 {Tags:[direction],Marker:1,Invisible:1,NoGravity:1,Invulnerable:1}
execute if entity @s[tag=l3_nozzlenose,nbt={OnGround:1b}] run summon armor_stand ^ ^ ^1 {Tags:[direction],Marker:1,Invisible:1,NoGravity:1,Invulnerable:1}
execute if entity @s[tag=l3_nozzlenose,nbt={OnGround:0b}] run function splatoon:shooters/accuracy/high_accuracy
...
execute if entity @s[team=blue] anchored eyes run summon item ^ ^ ^0.1 {Item:{id:"minecraft:blue_wool",Count:1},Age:-32767,PickupDelay:32767,Invulnerable:1,Tags:[nozzlenose_bullet,bullet,can_falloff,blue]}
execute if entity @s[team=yellow] anchored eyes run summon item ^ ^ ^0.1 {Item:{id:"minecraft:yellow_wool",Count:1},Age:-32767,PickupDelay:32767,Invulnerable:1,Tags:[nozzlenose_bullet,bullet,can_falloff,yellow]}
...
execute as @e[type=item,tag=nozzlenose_bullet,tag=!timer,limit=1,sort=nearest] run function splatoon:nozzlenoses/shoot_as_item
