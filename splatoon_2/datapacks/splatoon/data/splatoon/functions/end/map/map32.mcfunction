...
scoreboard players set total_blocks value 5769
...
execute store result score blue_blocks4 value run fill -360 40 60 -440 42 -60 gray_wool replace blue_wool
execute store result score yellow_blocks4 value run fill -360 40 60 -440 42 -60 gray_wool replace yellow_wool
execute store result score blue_blocks5 value run fill -360 43 60 -440 44 -60 gray_wool replace blue_wool
execute store result score yellow_blocks5 value run fill -360 43 60 -440 44 -60 gray_wool replace yellow_wool
