...
tellraw @a ["",{"text":"Game Results:","bold":true,"color":"green"},{"text":"\n-Blue: "},{"score":{"name":"Blue","objective":"score"}},{"text":" second(s)"},{"text":"\n-Yellow: "},{"score":{"name":"Yellow","objective":"score"}},{"text":" second(s)"}]
execute if score Blue score > Yellow score run tellraw @a {"text":"Yellow Wins!","color":"yellow"}
execute if score Blue score < Yellow score run tellraw @a {"text":"Blue Wins!","color":"blue"}
execute if score Blue score = Yellow score run tellraw @a {"text":"It's a tie!"}
execute if score Blue score matches 0 run tellraw @a {"text":"Knockout!","color":"red"}
execute if score Yellow score matches 0 run tellraw @a {"text":"Knockout!","color":"red"}
