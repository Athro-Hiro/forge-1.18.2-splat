execute at @s[tag=medium_accuracy] run function splatoon:shooters/accuracy/medium_accuracy
execute at @s[tag=low_accuracy] run function splatoon:shooters/accuracy/low_accuracy
...
execute if entity @s[tag=glooga_dualies,scores={rolltimer=1..}] run scoreboard players add damage value 18
...
execute as @e[type=item,tag=bullet,tag=!timer,limit=1,sort=nearest] run function splatoon:dualies/shoot_as_item
