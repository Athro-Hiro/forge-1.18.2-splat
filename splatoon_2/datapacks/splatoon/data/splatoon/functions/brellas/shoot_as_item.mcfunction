...
execute store result entity @s Motion[0] double 0.0000018 run scoreboard players get dx value
execute store result entity @s Motion[1] double 0.0000018 run scoreboard players get dy value
execute store result entity @s Motion[2] double 0.0000018 run scoreboard players get dz value
tag @s add timer