...
execute if entity @s[team=blue] anchored eyes run summon item ^ ^ ^0.1 {Item:{id:"minecraft:blue_wool",Count:1},NoGravity:1,Age:-32767,PickupDelay:32767,Invulnerable:1,Tags:[brella_bullet,bullet,blue]}
execute if entity @s[team=yellow] anchored eyes run summon item ^ ^ ^0.1 {Item:{id:"minecraft:yellow_wool",Count:1},NoGravity:1,Age:-32767,PickupDelay:32767,Invulnerable:1,Tags:[brella_bullet,bullet,yellow]}
...
execute as @e[type=item,tag=brella_bullet,tag=!timer,limit=1,sort=nearest] run function splatoon:brellas/shoot_as_item
