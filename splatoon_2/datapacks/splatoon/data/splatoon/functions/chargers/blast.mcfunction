...
execute if entity @s[tag=blue] run scoreboard players remove @a[team=yellow,distance=..1] health 50
execute if entity @s[tag=yellow] run scoreboard players remove @a[team=blue,distance=..1] health 50
execute if entity @s[tag=blue] run scoreboard players remove @a[team=yellow,distance=..3] health 50
execute if entity @s[tag=yellow] run scoreboard players remove @a[team=blue,distance=..3] health 50
