scoreboard players add weapon_selection_page value 1
execute if score weapon_selection_page value matches 12 run scoreboard players set weapon_selection_page value 1
