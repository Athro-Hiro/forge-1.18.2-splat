scoreboard players remove map_selection_page value 1
execute if score map_selection_page value matches 0 run scoreboard players set map_selection_page value 4
